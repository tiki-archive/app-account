...
import '../short_code/api_short_code_model_claim.dart';
import '../short_code/api_short_code_model_rsp.dart';
import '../short_code/api_short_code_repository.dart';
import 'tiki_api_model_rsp.dart';
...
class ApiShortCodeService {
  ...
  updateReferCount() async {
    UserAccountSignupRepository.total(model.referCode, httppClient, (total) {
